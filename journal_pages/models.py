...
class Journal_Entry(models.Model):
    entry_title = models.CharField(max_length=300, help_text="What is the title of today's Journal Entry?")
    entry_date =  models.DateField(auto_now_add=True)
    week_entry = models.CharField(max_length=1000, help_text="How did your week go? \nWhat successes did you experience?\
        What did you not achieve this week that you said you will?\n Any magic moments?")
    learn_entry = models.CharField(max_length=1000, help_text="What did I learn \
             in this week?  About myself?  Others? What do I plan to do \
                tomorrow, differently or the same?")
    interact_entry = models.CharField(max_length=1000, help_text="Who did you \
        interact with?  Anyone you need to update?  Who did you thank? Ask a \
        question with? Share info or feedback with?")
    goals_entry = models.CharField(max_length=1000, help_text="What are some \
    ...
    def save(self, *args, **kwargs):
        base_slug = slugify(self.entry_title + "-" + str(self.entry_date))
        self.slug = base_slug
